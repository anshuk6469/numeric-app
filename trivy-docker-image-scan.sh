...
docker run -v /var/run/docker.sock:/var/run/docker.sock -v $HOME/Library/Caches:/root/.cache/ ghcr.io/aquasecurity/trivy --severity CRITICAL --exit-code 0 --timeout 20m image $dockerImageName
